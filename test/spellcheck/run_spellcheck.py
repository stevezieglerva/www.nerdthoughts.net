...
class SubmissionSpellChecker():
	def __init__(self):
		...
		ignore_words = ["#", "##", "###", "####", "#####", "devops", "http", "com", "jpg", "miica", "trello", "solutioning", "etl", "oig", "owasp", "sonarqube", "php", "website", "handoffs", "standups", "sagemaker", "talend", "nutch", "gensim", "vscode", "tf", "idf", "markdown", "wireframes", "mvp", "nosql", "dynamodb", "prototyped", "retros", "devs", "cloudfront", "lambdas", "unittest", "unittest", "jasmine", "worldspace", "prioritized", "lambdas", "tokenizing", "leverages", "paas", "microservices", "vpc", "cloudtrail", "cloudwatch", "iam", "jumpcloud", "saml", "sso", "mysql", "virtualized", "cdn", "downloads", "mdasii", "userguide", "init", "decrypt", "venv", "vpcs", "pre-signed", "priv", "url", "etls", "decryption", "dwhadmn", "ziegler", "Vectorization", "Financialmodelingprep", "backend", "initializers", "rmsprop", "overfitting", "dirichlet", "py", "optimizes", "iac"]
...
text_lines = read_markdown_filtered_file("../../_drafts/devopsdays-rdu-2019.md")  
